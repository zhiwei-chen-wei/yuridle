...
searchKitsuChar('Sayaka Saeki');
searchKitsuChar('Chisato Nishikigi');
searchKitsuChar('Takina Inoue');
searchKitsuChar('Riri Hitotsuyanagi');
searchKitsuChar('Yuyu Shirai');
